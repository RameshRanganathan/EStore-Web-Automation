...
{
    internal class FragrancePage : PageBase
    {
        ...
        public FragrancePage(IWebDriver driver) : base(driver) { }

        public void GoTo()
        {
            driver.Navigate().GoToUrl("https://automationteststore.com/index.php?rt=product/category&path=49");
        }
